...
GLchar *c3_exercise_2::vertexSource()
{
	return
		"#version 150\n"
		"in vec2 position;"
...
GLchar *c3_exercise_2::fragmentSource()
{
	return
		"#version 150\n"
		"in vec3 Color;"
...
GLuint c3_exercise_2::compileShader(const GLchar *shaderStr, GLenum eShaderType)
{
...
void c3_exercise_2::setTextureParameters()
{
...
GLuint c3_exercise_2::loadTexture()
{
	GLuint tex;
	glGenTextures(1, &tex);
...
GLuint c3_exercise_2::generateVBO() // VBO (Vertex Buffer Object)
{
	GLuint vbo;
...
GLuint c3_exercise_2::generateEBO()
{
	GLuint ebo;
	glGenBuffers(1, &ebo);
