...
GLchar *c3_basic::fragmentSource()
{
	return
		"#version 150\n"
		"in vec3 Color;"
...
GLuint c3_basic::compileShader(const GLchar *shaderStr, GLenum eShaderType)
{
...
void c3_basic::setTextureParameters()
{
...
GLuint c3_basic::generateVBO() // VBO (Vertex Buffer Object)
{
	GLuint vbo;
