...
GLchar *c3_exercise_1::vertexSource()
{
	return
		"#version 150\n"
		"in vec2 position;"
...
GLchar *c3_exercise_1::fragmentSource()
{
	return
		"#version 150\n"
		"in vec3 Color;"
...
GLuint c3_exercise_1::compileShader(const GLchar *shaderStr, GLenum eShaderType)
{
...
void c3_exercise_1::setTextureParameters()
{
...
GLuint c3_exercise_1::generateVBO() // VBO (Vertex Buffer Object)
{
	GLuint vbo;
...
GLuint c3_exercise_1::generateEBO()
{
	GLuint ebo;
	glGenBuffers(1, &ebo);
