...
GLchar *c3_multitexture::vertexSource()
{
	return
		"#version 150\n"
		"in vec2 position;"
...
GLchar *c3_multitexture::fragmentSource()
{
	return
		"#version 150\n"
		"in vec3 Color;"
...
GLuint c3_multitexture::compileShader(const GLchar *shaderStr, GLenum eShaderType)
{
...
void c3_multitexture::setTextureParameters()
{
...
void c3_multitexture::loadTextures(std::array<GLuint, 2> &textures, GLuint shaderProgram)
{
...
GLuint c3_multitexture::generateVBO() // VBO (Vertex Buffer Object)
{
	GLuint vbo;
...
GLuint c3_multitexture::generateEBO()
{
	GLuint ebo;
	glGenBuffers(1, &ebo);
