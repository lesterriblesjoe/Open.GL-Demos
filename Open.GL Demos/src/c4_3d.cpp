...
GLuint c4_3d::compileShader(const GLchar *shaderStr, GLenum eShaderType)
{
...
void c4_3d::setTextureParameters()
{
...
void c4_3d::loadTextures(std::array<GLuint, 2> &textures, GLuint shaderProgram)
{
...
GLuint c4_3d::generateVBO() // VBO (Vertex Buffer Object)
{
	GLuint vbo;
