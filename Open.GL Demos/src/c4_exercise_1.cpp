...
GLchar *c4_exercise_1::vertexSource()
{
	return
		"#version 150\n"
		"in vec2 position;"
...
GLchar *c4_exercise_1::fragmentSource()
{
	return
		"#version 150\n"
		"in vec3 Color;"
...
GLuint c4_exercise_1::compileShader(const GLchar *shaderStr, GLenum eShaderType)
{
...
void c4_exercise_1::setTextureParameters()
{
...
void c4_exercise_1::loadTextures(std::array<GLuint, 2> &textures, GLuint shaderProgram)
{
...
GLuint c4_exercise_1::generateVBO() // VBO (Vertex Buffer Object)
{
	GLuint vbo;
...
GLuint c4_exercise_1::generateEBO()
{
	GLuint ebo;
	glGenBuffers(1, &ebo);
...
void c4_exercise_1::run()
{
	...
	while (true)
	{
		...
		// 5x speed + 0-1.5x size
		GLfloat scale = (sin(time * 5.0f) + 1.0f) / 1.5f;
