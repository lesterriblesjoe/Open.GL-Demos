...
GLchar *c4_transformation::vertexSource()
{
	return
		"#version 150\n"
		"in vec2 position;"
...
GLchar *c4_transformation::fragmentSource()
{
	return
		"#version 150\n"
		"in vec3 Color;"
...
GLuint c4_transformation::compileShader(const GLchar *shaderStr, GLenum eShaderType)
{
...
void c4_transformation::setTextureParameters()
{
...
void c4_transformation::loadTextures(std::array<GLuint, 2> &textures, GLuint shaderProgram)
{
...
GLuint c4_transformation::generateVBO() // VBO (Vertex Buffer Object)
{
	GLuint vbo;
...
GLuint c4_transformation::generateEBO()
{
	GLuint ebo;
	glGenBuffers(1, &ebo);
...
void c4_transformation::run()
{
	...
	while (true)
	{
		...
		glm::mat4 trans;
		trans = glm::rotate(trans, time * -180.0f, glm::vec3(0.0f, 0.0f, 1.0f));
